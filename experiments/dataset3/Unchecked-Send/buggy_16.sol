...
abstract contract ERC20Interface {
    ...
    function balanceOf(address tokenOwner) external view virtual returns (uint256 balance);
function bug_unchk_send18() payable public{
    payable(msg.sender).transfer(1 ether);}
    function allowance(address tokenOwner, address spender) external view virtual returns (uint256 remaining);
