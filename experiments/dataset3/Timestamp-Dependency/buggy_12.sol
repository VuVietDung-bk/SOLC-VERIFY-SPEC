...
uint256 bugv_tmstmp1 = block.timestamp;
    ...
    function transfer(address _to, uint _value, bytes memory _data) public override transferable(msg.sender) returns (bool) {
...
function play_tmstmp27(uint startTime) public {
    ...
    function transfer(address _to, uint _value) public override transferable(msg.sender) returns (bool) {
