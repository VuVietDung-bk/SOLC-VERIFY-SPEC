...
function play_tmstmp10(uint startTime) public {
    ...
    function allowance(address holder, address spender) public view override(IERC20) returns (uint256) {
...
function bug_tmstmp12 () public payable {
    ...
    function transferFrom(address holder, address recipient, uint256 amount) external override(IERC20) returns (bool) {
        require(recipient != address(0), "ERC777: transfer to the zero address");
