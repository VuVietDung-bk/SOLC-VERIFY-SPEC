...
mapping(address => uint) public lockTime_intou9;
    function actualBalanceOf(address _owner) public view virtual returns (uint);
...
function transfer_intou14(address _to, uint _value) public returns (bool) {
        ...
        returns (uint voteID)
    {
        ...
        p.votes.push(Vote({inSupport: supportsProposal, voter: msg.sender}));
