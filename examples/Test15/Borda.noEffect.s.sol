...
contract Borda is IBorda{
    ...
    /// @notice postcondition forall (address c) !((c != f) && (c != s) && (c != t)) || ((_voted[c] == __verifier_old_bool(_voted[c]) || c == msg.sender) && _points[c] == __verifier_old_uint(_points[c]))
