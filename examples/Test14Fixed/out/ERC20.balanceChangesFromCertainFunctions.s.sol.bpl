...
procedure {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 175, 5} {:message "ERC20::transferFrom"} transferFrom#199(__this: address_t, __msg_sender: address_t, __msg_value: int, sender#155: address_t, recipient#157: address_t, amount#159: int)
	returns (#163: bool)
{
	var {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 180, 9} {:message "currentAllowance"} currentAllowance#166: int;
	...
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 185, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 206, 5} {:message "ERC20::increaseAllowance"} increaseAllowance#226(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#202: address_t, addedValue#204: int)
	returns (#207: bool)
	requires {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 206, 5} {:message "Precondition 'addedValue >= 0' might not hold when entering function."} (addedValue#204 >= 0);

	ensures {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 206, 5} {:message "Postcondition 'forall (address user) !(_balances[user] != __verifier_old_uint(_balances[user]))' might not hold at end of function."} (forall user#2: address_t :: !((_balances#12[__this][user#2] != old(_balances#12[__this][user#2]))));

{
	...
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 211, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 235, 5} {:message "ERC20::decreaseAllowance"} decreaseAllowance#257(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#229: address_t, subtractedValue#231: int)
	returns (#234: bool)
	requires {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 235, 5} {:message "Precondition 'subtractedValue >= 0' might not hold when entering function."} (subtractedValue#231 >= 0);

	ensures {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 235, 5} {:message "Postcondition 'forall (address user) !(_balances[user] != __verifier_old_uint(_balances[user]))' might not hold at end of function."} (forall user#2: address_t :: !((_balances#12[__this][user#2] != old(_balances#12[__this][user#2]))));

{
	var {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 240, 9} {:message "currentAllowance"} currentAllowance#237: int;
	...
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 242, 9} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 261, 5} {:message "ERC20::_transfer"} _transfer#333(__this: address_t, __msg_sender: address_t, __msg_value: int, sender#260: address_t, recipient#262: address_t, amount#264: int)
{
	var call_arg#9: int_arr_ptr;
	var new_array#10: int_arr_ptr;
	var call_arg#11: int_arr_ptr;
	var new_array#12: int_arr_ptr;
	var {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 271, 9} {:message "senderBalance"} senderBalance#294: int;
	...
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 269, 9} {:message ""} true;
	...
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 279, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, sender#260, recipient#262, amount#264);
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 281, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 293, 5} {:message "ERC20::mint"} mint#392(__this: address_t, __msg_sender: address_t, __msg_value: int, account#336: address_t, amount#338: int)
{
	...
	call_arg#19 := 0;
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 296, 9} {:message ""} true;
	...
	call_arg#20 := 0;
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 300, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, call_arg#20, account#336, amount#338);
	call_arg#21 := 0;
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 302, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 316, 5} {:message "ERC20::burn"} burn#466(__this: address_t, __msg_sender: address_t, __msg_value: int, account#395: address_t, amount#397: int)
{
	var call_arg#24: int_arr_ptr;
	var new_array#25: int_arr_ptr;
	var call_arg#26: address_t;
	var {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 321, 9} {:message "accountBalance"} accountBalance#423#23: int;
	...
	call_arg#26 := 0;
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 319, 9} {:message ""} true;
	...
	call_arg#29 := 0;
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 326, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, account#395, call_arg#29, amount#397);
	call_arg#30 := 0;
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 328, 9} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 344, 5} {:message "ERC20::_approve"} _approve#511(__this: address_t, __msg_sender: address_t, __msg_value: int, owner#469: address_t, spender#471: address_t, amount#473: int)
{
	...
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 352, 14} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 369, 5} {:message "ERC20::_beforeTokenTransfer"} _beforeTokenTransfer#522(__this: address_t, __msg_sender: address_t, __msg_value: int, from#514: address_t, to#516: address_t, amount#518: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
	// Function body starts here
...
procedure {:inline 1} {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 389, 5} {:message "ERC20::_afterTokenTransfer"} _afterTokenTransfer#533(__this: address_t, __msg_sender: address_t, __msg_value: int, from#525: address_t, to#527: address_t, amount#529: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
	// Function body starts here
...
// 
// Function: deposit
procedure {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 395, 5} {:message "ERC20::deposit"} deposit#545(__this: address_t, __msg_sender: address_t, __msg_value: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
...
// 
// Function: withdraw
procedure {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 399, 5} {:message "ERC20::withdraw"} withdraw#581(__this: address_t, __msg_sender: address_t, __msg_value: int, amount#547: int)
{
	var {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 402, 10} {:message "success"} success#567: bool;
	...
	assume {:sourceloc "ERC20.balanceChangesFromCertainFunctions.s.sol", 402, 28} {:message ""} true;
