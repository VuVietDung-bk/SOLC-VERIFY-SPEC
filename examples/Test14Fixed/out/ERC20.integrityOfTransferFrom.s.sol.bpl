...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 177, 5} {:message "ERC20::transferFrom"} transferFrom#199(__this: address_t, __msg_sender: address_t, __msg_value: int, sender#155: address_t, recipient#157: address_t, amount#159: int)
	returns (#163: bool)
	requires {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 177, 5} {:message "Precondition 'amount >= 0' might not hold when entering function."} (amount#159 >= 0);
	requires {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 177, 5} {:message "Precondition 'sender != recipient' might not hold when entering function."} (sender#155 != recipient#157);
	requires {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 177, 5} {:message "Precondition 'amount != 0' might not hold when entering function."} (amount#159 != 0);

	ensures {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 177, 5} {:message "Postcondition '__verifier_old_uint(_allowances[sender][msg.sender]) > _allowances[sender][msg.sender]' might not hold at end of function."} (old(_allowances#18[__this][sender#155][__msg_sender]) > _allowances#18[__this][sender#155][__msg_sender]);

{
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 182, 9} {:message "currentAllowance"} currentAllowance#166: int;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 187, 9} {:message ""} true;
	call _approve#511(__this, __msg_sender, __msg_value, sender#155, call_arg#6, (currentAllowance#166 - amount#159));
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 189, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 206, 5} {:message "ERC20::increaseAllowance"} increaseAllowance#226(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#202: address_t, addedValue#204: int)
	returns (#207: bool)
{
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 211, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 233, 5} {:message "ERC20::decreaseAllowance"} decreaseAllowance#257(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#229: address_t, subtractedValue#231: int)
	returns (#234: bool)
{
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 238, 9} {:message "currentAllowance"} currentAllowance#237: int;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 240, 9} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 259, 5} {:message "ERC20::_transfer"} _transfer#333(__this: address_t, __msg_sender: address_t, __msg_value: int, sender#260: address_t, recipient#262: address_t, amount#264: int)
{
	var call_arg#9: int_arr_ptr;
	var new_array#10: int_arr_ptr;
	var call_arg#11: int_arr_ptr;
	var new_array#12: int_arr_ptr;
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 269, 9} {:message "senderBalance"} senderBalance#294: int;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 267, 9} {:message ""} true;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 277, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, sender#260, recipient#262, amount#264);
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 279, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 291, 5} {:message "ERC20::mint"} mint#392(__this: address_t, __msg_sender: address_t, __msg_value: int, account#336: address_t, amount#338: int)
{
	...
	call_arg#19 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 294, 9} {:message ""} true;
	...
	call_arg#20 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 298, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, call_arg#20, account#336, amount#338);
	call_arg#21 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 300, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 314, 5} {:message "ERC20::burn"} burn#466(__this: address_t, __msg_sender: address_t, __msg_value: int, account#395: address_t, amount#397: int)
{
	var call_arg#24: int_arr_ptr;
	var new_array#25: int_arr_ptr;
	var call_arg#26: address_t;
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 319, 9} {:message "accountBalance"} accountBalance#423#23: int;
	...
	call_arg#26 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 317, 9} {:message ""} true;
	...
	call_arg#29 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 324, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, account#395, call_arg#29, amount#397);
	call_arg#30 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 326, 9} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 342, 5} {:message "ERC20::_approve"} _approve#511(__this: address_t, __msg_sender: address_t, __msg_value: int, owner#469: address_t, spender#471: address_t, amount#473: int)
{
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 350, 14} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 367, 5} {:message "ERC20::_beforeTokenTransfer"} _beforeTokenTransfer#522(__this: address_t, __msg_sender: address_t, __msg_value: int, from#514: address_t, to#516: address_t, amount#518: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
	// Function body starts here
...
procedure {:inline 1} {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 387, 5} {:message "ERC20::_afterTokenTransfer"} _afterTokenTransfer#533(__this: address_t, __msg_sender: address_t, __msg_value: int, from#525: address_t, to#527: address_t, amount#529: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
	// Function body starts here
...
// 
// Function: deposit
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 393, 5} {:message "ERC20::deposit"} deposit#545(__this: address_t, __msg_sender: address_t, __msg_value: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
...
// 
// Function: withdraw
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 397, 5} {:message "ERC20::withdraw"} withdraw#581(__this: address_t, __msg_sender: address_t, __msg_value: int, amount#547: int)
{
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 400, 10} {:message "success"} success#567: bool;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 400, 28} {:message ""} true;
