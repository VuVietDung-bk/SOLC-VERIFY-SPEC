...
procedure {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 122, 5} {:message "ERC20::transfer"} transfer#113(__this: address_t, __msg_sender: address_t, __msg_value: int, recipient#95: address_t, amount#97: int)
	...
	ensures {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 122, 5} {:message "Postcondition '!(_totalSupply != __verifier_old_uint(_totalSupply)) || (msg.sender == _owner)' might not hold at end of function."} (!((_totalSupply#20[__this] != old(_totalSupply#20[__this]))) || (__msg_sender == _owner#22[__this]));
...
procedure {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 154, 5} {:message "ERC20::approve"} approve#152(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#134: address_t, amount#136: int)
	...
	ensures {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 154, 5} {:message "Postcondition '!(_totalSupply != __verifier_old_uint(_totalSupply)) || (msg.sender == _owner)' might not hold at end of function."} (!((_totalSupply#20[__this] != old(_totalSupply#20[__this]))) || (__msg_sender == _owner#22[__this]));
...
procedure {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 179, 5} {:message "ERC20::transferFrom"} transferFrom#199(__this: address_t, __msg_sender: address_t, __msg_value: int, sender#155: address_t, recipient#157: address_t, amount#159: int)
	...
	ensures {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 179, 5} {:message "Postcondition '!(_totalSupply != __verifier_old_uint(_totalSupply)) || (msg.sender == _owner)' might not hold at end of function."} (!((_totalSupply#20[__this] != old(_totalSupply#20[__this]))) || (__msg_sender == _owner#22[__this]));
...
procedure {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 210, 5} {:message "ERC20::increaseAllowance"} increaseAllowance#226(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#202: address_t, addedValue#204: int)
	...
	ensures {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 210, 5} {:message "Postcondition '!(_totalSupply != __verifier_old_uint(_totalSupply)) || (msg.sender == _owner)' might not hold at end of function."} (!((_totalSupply#20[__this] != old(_totalSupply#20[__this]))) || (__msg_sender == _owner#22[__this]));
...
procedure {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 239, 5} {:message "ERC20::decreaseAllowance"} decreaseAllowance#257(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#229: address_t, subtractedValue#231: int)
	...
	ensures {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 239, 5} {:message "Postcondition '!(_totalSupply != __verifier_old_uint(_totalSupply)) || (msg.sender == _owner)' might not hold at end of function."} (!((_totalSupply#20[__this] != old(_totalSupply#20[__this]))) || (__msg_sender == _owner#22[__this]));
...
procedure {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 299, 5} {:message "ERC20::mint"} mint#392(__this: address_t, __msg_sender: address_t, __msg_value: int, account#336: address_t, amount#338: int)
	...
	ensures {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 299, 5} {:message "Postcondition '!(_totalSupply != __verifier_old_uint(_totalSupply)) || (msg.sender == _owner)' might not hold at end of function."} (!((_totalSupply#20[__this] != old(_totalSupply#20[__this]))) || (__msg_sender == _owner#22[__this]));
...
procedure {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 324, 5} {:message "ERC20::burn"} burn#466(__this: address_t, __msg_sender: address_t, __msg_value: int, account#395: address_t, amount#397: int)
	...
	ensures {:sourceloc "ERC20.onlyOwnersMayChangeTotalSupply.s.sol", 324, 5} {:message "Postcondition '!(_totalSupply != __verifier_old_uint(_totalSupply)) || (msg.sender == _owner)' might not hold at end of function."} (!((_totalSupply#20[__this] != old(_totalSupply#20[__this]))) || (__msg_sender == _owner#22[__this]));
