...
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 125, 5} {:message "ERC20::transfer"} transfer#113(__this: address_t, __msg_sender: address_t, __msg_value: int, recipient#95: address_t, amount#97: int)
	returns (#101: bool)
	requires {:sourceloc "ERC20.transferDoesntRevert.s.sol", 125, 5} {:message "Precondition '_balances[msg.sender] > amount' might not hold when entering function."} (_balances#12[__this][__msg_sender] > amount#97);
	requires {:sourceloc "ERC20.transferDoesntRevert.s.sol", 125, 5} {:message "Precondition 'msg.value == 0' might not hold when entering function."} (__msg_value == 0);
	requires {:sourceloc "ERC20.transferDoesntRevert.s.sol", 125, 5} {:message "Precondition 'msg.sender != address(0)' might not hold when entering function."} (__msg_sender != 0);
	requires {:sourceloc "ERC20.transferDoesntRevert.s.sol", 125, 5} {:message "Precondition 'recipient != address(0)' might not hold when entering function."} (recipient#95 != 0);

	ensures {:sourceloc "ERC20.transferDoesntRevert.s.sol", 125, 5} {:message "Postcondition 'false' might not hold at end of function."} false;

{
	...
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 131, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 138, 5} {:message "ERC20::allowance"} allowance#131(__this: address_t, __msg_sender: address_t, __msg_value: int, owner#116: address_t, spender#118: address_t)
	returns (#122: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
...
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 155, 5} {:message "ERC20::approve"} approve#152(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#134: address_t, amount#136: int)
	returns (#140: bool)
{
	...
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 161, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 178, 5} {:message "ERC20::transferFrom"} transferFrom#199(__this: address_t, __msg_sender: address_t, __msg_value: int, sender#155: address_t, recipient#157: address_t, amount#159: int)
	returns (#163: bool)
{
	var {:sourceloc "ERC20.transferDoesntRevert.s.sol", 183, 9} {:message "currentAllowance"} currentAllowance#166: int;
	...
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 188, 9} {:message ""} true;
	call _approve#511(__this, __msg_sender, __msg_value, sender#155, call_arg#6, (currentAllowance#166 - amount#159));
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 190, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 207, 5} {:message "ERC20::increaseAllowance"} increaseAllowance#226(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#202: address_t, addedValue#204: int)
	returns (#207: bool)
{
	...
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 212, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 234, 5} {:message "ERC20::decreaseAllowance"} decreaseAllowance#257(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#229: address_t, subtractedValue#231: int)
	returns (#234: bool)
{
	var {:sourceloc "ERC20.transferDoesntRevert.s.sol", 239, 9} {:message "currentAllowance"} currentAllowance#237: int;
	...
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 241, 9} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.transferDoesntRevert.s.sol", 260, 5} {:message "ERC20::_transfer"} _transfer#333(__this: address_t, __msg_sender: address_t, __msg_value: int, sender#260: address_t, recipient#262: address_t, amount#264: int)
{
	var call_arg#9: int_arr_ptr;
	var new_array#10: int_arr_ptr;
	var call_arg#11: int_arr_ptr;
	var new_array#12: int_arr_ptr;
	var {:sourceloc "ERC20.transferDoesntRevert.s.sol", 270, 9} {:message "senderBalance"} senderBalance#294: int;
	...
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 268, 9} {:message ""} true;
	...
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 278, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, sender#260, recipient#262, amount#264);
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 280, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 292, 5} {:message "ERC20::mint"} mint#392(__this: address_t, __msg_sender: address_t, __msg_value: int, account#336: address_t, amount#338: int)
{
	...
	call_arg#19 := 0;
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 295, 9} {:message ""} true;
	...
	call_arg#20 := 0;
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 299, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, call_arg#20, account#336, amount#338);
	call_arg#21 := 0;
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 301, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 315, 5} {:message "ERC20::burn"} burn#466(__this: address_t, __msg_sender: address_t, __msg_value: int, account#395: address_t, amount#397: int)
{
	var call_arg#24: int_arr_ptr;
	var new_array#25: int_arr_ptr;
	var call_arg#26: address_t;
	var {:sourceloc "ERC20.transferDoesntRevert.s.sol", 320, 9} {:message "accountBalance"} accountBalance#423#23: int;
	...
	call_arg#26 := 0;
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 318, 9} {:message ""} true;
	...
	call_arg#29 := 0;
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 325, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, account#395, call_arg#29, amount#397);
	call_arg#30 := 0;
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 327, 9} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.transferDoesntRevert.s.sol", 343, 5} {:message "ERC20::_approve"} _approve#511(__this: address_t, __msg_sender: address_t, __msg_value: int, owner#469: address_t, spender#471: address_t, amount#473: int)
{
	...
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 351, 14} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.transferDoesntRevert.s.sol", 368, 5} {:message "ERC20::_beforeTokenTransfer"} _beforeTokenTransfer#522(__this: address_t, __msg_sender: address_t, __msg_value: int, from#514: address_t, to#516: address_t, amount#518: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
	// Function body starts here
...
procedure {:inline 1} {:sourceloc "ERC20.transferDoesntRevert.s.sol", 388, 5} {:message "ERC20::_afterTokenTransfer"} _afterTokenTransfer#533(__this: address_t, __msg_sender: address_t, __msg_value: int, from#525: address_t, to#527: address_t, amount#529: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
	// Function body starts here
...
// 
// Function: deposit
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 394, 5} {:message "ERC20::deposit"} deposit#545(__this: address_t, __msg_sender: address_t, __msg_value: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
...
// 
// Function: withdraw
procedure {:sourceloc "ERC20.transferDoesntRevert.s.sol", 398, 5} {:message "ERC20::withdraw"} withdraw#581(__this: address_t, __msg_sender: address_t, __msg_value: int, amount#547: int)
{
	var {:sourceloc "ERC20.transferDoesntRevert.s.sol", 401, 10} {:message "success"} success#567: bool;
	...
	assume {:sourceloc "ERC20.transferDoesntRevert.s.sol", 401, 28} {:message ""} true;
