...
// 
// ------- Source: ERC20.integrityOfTransferFrom.s.sol -------
...
var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 35, 5} {:message "_balances"} _balances#12: [address_t][address_t]int;
// 
// State variable: _allowances: mapping(address => mapping(address => uint256))
var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 37, 5} {:message "_allowances"} _allowances#18: [address_t][address_t][address_t]int;
// 
// State variable: _totalSupply: uint256
var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 39, 5} {:message "_totalSupply"} _totalSupply#20: [address_t]int;
// 
// State variable: _owner: address
var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 41, 5} {:message "_owner"} _owner#22: [address_t]address_t;
function {:builtin "((as const (Array Int Int)) 0)"} default_address_t_int() returns ([address_t]int);
function {:builtin "((as const (Array Int (Array Int Int))) ((as const (Array Int Int)) 0))"} default_address_t__k_address_t_v_int() returns ([address_t][address_t]int);
// 
// Function: 
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 52, 5} {:message "ERC20::[constructor]"} __constructor#582(__this: address_t, __msg_sender: address_t, __msg_value: int)
{
	// TCC assumptions
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 63, 5} {:message "ERC20::name"} name#48(__this: address_t, __msg_sender: address_t, __msg_value: int)
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 71, 5} {:message "ERC20::symbol"} symbol#58(__this: address_t, __msg_sender: address_t, __msg_value: int)
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 88, 5} {:message "ERC20::decimals"} decimals#68(__this: address_t, __msg_sender: address_t, __msg_value: int)
	returns (#63: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 95, 5} {:message "ERC20::totalSupply"} totalSupply#78(__this: address_t, __msg_sender: address_t, __msg_value: int)
	returns (#73: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 102, 5} {:message "ERC20::balanceOf"} balanceOf#92(__this: address_t, __msg_sender: address_t, __msg_value: int, account#81: address_t)
	returns (#85: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 120, 5} {:message "ERC20::transfer"} transfer#113(__this: address_t, __msg_sender: address_t, __msg_value: int, recipient#95: address_t, amount#97: int)
	returns (#101: bool)
{
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 126, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 133, 5} {:message "ERC20::allowance"} allowance#131(__this: address_t, __msg_sender: address_t, __msg_value: int, owner#116: address_t, spender#118: address_t)
	returns (#122: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 150, 5} {:message "ERC20::approve"} approve#152(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#134: address_t, amount#136: int)
	returns (#140: bool)
{
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 156, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 176, 5} {:message "ERC20::transferFrom"} transferFrom#199(__this: address_t, __msg_sender: address_t, __msg_value: int, sender#155: address_t, recipient#157: address_t, amount#159: int)
	returns (#163: bool)
	requires {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 176, 5} {:message "Precondition 'amount >= 0' might not hold when entering function."} (amount#159 >= 0);
	requires {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 176, 5} {:message "Precondition 'sender != recipient' might not hold when entering function."} (sender#155 != recipient#157);

	ensures {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 176, 5} {:message "Postcondition '__verifier_old_uint(_allowances[sender][msg.sender]) > _allowances[sender][msg.sender]' might not hold at end of function."} (old(_allowances#18[__this][sender#155][__msg_sender]) > _allowances#18[__this][sender#155][__msg_sender]);

{
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 181, 9} {:message "currentAllowance"} currentAllowance#166: int;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 186, 9} {:message ""} true;
	call _approve#511(__this, __msg_sender, __msg_value, sender#155, call_arg#6, (currentAllowance#166 - amount#159));
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 188, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 205, 5} {:message "ERC20::increaseAllowance"} increaseAllowance#226(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#202: address_t, addedValue#204: int)
	returns (#207: bool)
{
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 210, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 232, 5} {:message "ERC20::decreaseAllowance"} decreaseAllowance#257(__this: address_t, __msg_sender: address_t, __msg_value: int, spender#229: address_t, subtractedValue#231: int)
	returns (#234: bool)
{
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 237, 9} {:message "currentAllowance"} currentAllowance#237: int;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 239, 9} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 258, 5} {:message "ERC20::_transfer"} _transfer#333(__this: address_t, __msg_sender: address_t, __msg_value: int, sender#260: address_t, recipient#262: address_t, amount#264: int)
{
	var call_arg#9: int_arr_ptr;
	var new_array#10: int_arr_ptr;
	var call_arg#11: int_arr_ptr;
	var new_array#12: int_arr_ptr;
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 268, 9} {:message "senderBalance"} senderBalance#294: int;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 266, 9} {:message ""} true;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 276, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, sender#260, recipient#262, amount#264);
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 278, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 290, 5} {:message "ERC20::mint"} mint#392(__this: address_t, __msg_sender: address_t, __msg_value: int, account#336: address_t, amount#338: int)
{
	...
	call_arg#19 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 293, 9} {:message ""} true;
	...
	call_arg#20 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 297, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, call_arg#20, account#336, amount#338);
	call_arg#21 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 299, 9} {:message ""} true;
...
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 313, 5} {:message "ERC20::burn"} burn#466(__this: address_t, __msg_sender: address_t, __msg_value: int, account#395: address_t, amount#397: int)
{
	var call_arg#24: int_arr_ptr;
	var new_array#25: int_arr_ptr;
	var call_arg#26: address_t;
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 318, 9} {:message "accountBalance"} accountBalance#423#23: int;
	...
	call_arg#26 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 316, 9} {:message ""} true;
	...
	call_arg#29 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 323, 14} {:message ""} true;
	call Transfer#666(__this, __msg_sender, __msg_value, account#395, call_arg#29, amount#397);
	call_arg#30 := 0;
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 325, 9} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 341, 5} {:message "ERC20::_approve"} _approve#511(__this: address_t, __msg_sender: address_t, __msg_value: int, owner#469: address_t, spender#471: address_t, amount#473: int)
{
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 349, 14} {:message ""} true;
...
procedure {:inline 1} {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 366, 5} {:message "ERC20::_beforeTokenTransfer"} _beforeTokenTransfer#522(__this: address_t, __msg_sender: address_t, __msg_value: int, from#514: address_t, to#516: address_t, amount#518: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
	// Function body starts here
...
procedure {:inline 1} {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 386, 5} {:message "ERC20::_afterTokenTransfer"} _afterTokenTransfer#533(__this: address_t, __msg_sender: address_t, __msg_value: int, from#525: address_t, to#527: address_t, amount#529: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
	// Function body starts here
...
// 
// Function: deposit
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 392, 5} {:message "ERC20::deposit"} deposit#545(__this: address_t, __msg_sender: address_t, __msg_value: int)
{
	// TCC assumptions
	assume (__msg_sender != 0);
...
// 
// Function: withdraw
procedure {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 396, 5} {:message "ERC20::withdraw"} withdraw#581(__this: address_t, __msg_sender: address_t, __msg_value: int, amount#547: int)
{
	var {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 399, 10} {:message "success"} success#567: bool;
	...
	assume {:sourceloc "ERC20.integrityOfTransferFrom.s.sol", 399, 28} {:message ""} true;
